...
#
# INCOMPLETE: the provider requires instance_class, engine, allocated_storage, username,
# which a finding cannot supply. The TODO placeholders below satisfy type checking only
# -- replace each with the resource's real value, or the import will reconfigure the
# resource incorrectly.
# Resources below: 1

# billing-primary
# TODO: replace the instance_class, engine, allocated_storage, username placeholder(s)
